...
const Training = () => {
    ...
    const computerFindNextMoves = (newTurn) => {
        ...
        switch (openingData[movesList][newTurn][0]) {
            ...
            case "v":
                console.log("case : v");
                console.log(openingData[movesList][newTurn]);
                ...
                nextMoves = openingData[newMovesList][1];
                console.log("Next Move : " + openingData[newMovesList][1][1]);
                if(nextMoves[0] === "c"){
                    let castleMove = findCastleMoves(nextMoves[1], 1);
                    console.log("Castle Move : " + castleMove);
                    return castleMove.concat([newMovesList]);
                }else{
                    return [[nextMoves[1]], 1, newMovesList];
                }
    ...
    const checkMoveValidity = (myMove, goodMove) => {
        ...
        if(piece > 0){
            if(pieceInHand.length > 0){
                if(Math.floor(piece/10) === Math.floor(pieceInHand[1]/10)){
                    ...
                    let move = ["m", [tupleToNotation([pieceInHand[0][0], pieceInHand[0][1]]), tupleToNotation([l, c])]];
                    console.log("Check Move Validity : " + checkMoveValidity(move, openingData[movesList][boardSetup[1]]));
    ...
    */
    ...
    return (
        <div className="trainingContainer">
            <h1 onClick={() => updateChessboard()}>{openingData['name']}</h1>
